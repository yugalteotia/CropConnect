...
//   textDecoration: 'none',
//   display: 'block',
//   marginBottom: '5px', // Reduced margin to reduce spacing
// };
...
//       {data.map(({ srNo, title, date, links }) => (
//         <div key={srNo} style={cardStyles} className="card">
//           <div className="card-body">
//             <h5 className="card-title" style={cardTitleStyles}>{title}</h5>
//             <h6 className="card-subtitle mb-2 text-muted" style={cardDateStyles}>{date}</h6>
//             {links.map((link, index) => (
//               <div key={index}>
//                 <a href={link.href} target="_blank" rel="noopener noreferrer" style={linkStyles}>
//                   {link.text}
